...
class Config:
    def __init__(self):
        ...
        self.parser.add_argument('--input_image_path', default='DIPDKP/data/datasets/Set5/HR/baby.png',
                                 help='path to one specific image file')
        ...
        # Sizes
        self.parser.add_argument('--sf', type=int, default=4, help='The upsampling scale factor')
