...
#from model.model_VAE import DIPDKP
import time
import datetime
        ...
        for Q in range(len(I_loop_xs)):
            ...
            # I_loop_k = 3  # The number of the meta-learning P, default = 3
                ...
                for j in range(len(D_loops)):
                    D_loop = D_loops[j]
                    datasets = []
                    datasets.append('Set5')                                          ## 跑SynthetiData给注释了
                    ...
                    for k in range(len(datasets)):
                        ...
                        for i in range(len(methods)):
                            ...
                            prog.add_argument('--sf', type=str, default='4', help='The wanted SR scale factor')                                    ## 默认4倍超分
                            ...
                            args.input_dir = '../data/datasets/{}/DIPDKP_lr_x{}'.format(args.dataset, args.sf)      ## 输入的文件夹
                            print(args.input_dir)                                                                   ## 输出输入文件夹
